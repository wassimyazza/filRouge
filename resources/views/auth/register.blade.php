...
<body class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-md">
    ...
    <h1 class="text-center text-3xl font-bold text-gray-900">Create an account</h1>
    <p class="mt-2 text-center text-sm text-gray-600">Join us to start booking your perfect stays</p>
  </div>
    ...
    <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        ...
        <div class="space-y-4">
          <div class="flex items-center">
            ...
            <label for="agree-terms" class="ml-2 block text-sm text-gray-900">
              I agree to the 
              <a href="terms.html" class="font-medium text-teal-600 hover:text-teal-500">Terms of Service</a> 
              and 
              <a href="privacy.html" class="font-medium text-teal-600 hover:text-teal-500">Privacy Policy</a>
            </label>
          </div>
          ...
          <div class="flex items-center">
            <input 
              ...
              class="h-4 w-4 text-teal-600 focus:ring-teal-500 border-gray-300 rounded"
            />
            <label for="subscribe-newsletter" class="ml-2 block text-sm text-gray-900">
      ...
      <div class="mt-6 text-center">
        <p class="text-sm text-gray-600">
          ...
          <a href="login.html" class="font-medium text-teal-600 hover:text-teal-500">
            Sign in
          </a>
        </p>
      </div>
  ...
  <script>
    ...
    document.getElementById('register-form').addEventListener('submit', function(e) {
      ...
      // In a real app, this would send the form data to a server for registration
