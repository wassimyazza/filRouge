...
@section('title', 'List Your Property - Stay & Travel')

@section('content')
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-900">List Your Property</h1>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6 bg-blue-600 text-white">
                ...
                <p class="mt-1 text-sm text-blue-100">Fill in the details below to list your property. Fields marked with * are required.</p>
            </div>
            
            <form method="POST" action="{{ route('properties.store') }}" enctype="multipart/form-data" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="address" id="address" value="{{ old('address') }}" required maxlength="255"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                        ...
                        <input type="number" name="bedrooms" id="bedrooms" value="{{ old('bedrooms', 1) }}" required min="0"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        @error('bedrooms')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" name="bathrooms" id="bathrooms" value="{{ old('bathrooms', 1) }}" required min="0"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        @error('bathrooms')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        ...
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-gray-600">
                                <label for="images" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none">
                                    ...
                                    <input id="images" name="images[]" type="file" class="sr-only" multiple accept="image/jpeg,image/png,image/jpg">
                                </label>
                                <p class="pl-1">or drag and drop</p>
                            </div>
                            <p class="text-xs text-gray-500">
                                PNG, JPG, JPEG up to 2MB. First image will be the main image.
                            </p>
                        </div>
                    </div>
                    @error('images')
                ...
                <div class="p-4 bg-yellow-50 border-l-4 border-yellow-400 text-yellow-700 mb-8">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm">
                                Your property listing will be reviewed by our team before it becomes visible to travelers.
    ...
    document.getElementById('images').addEventListener('change', function(event) {
        ...
        for (let i = 0; i < files.length; i++) {
            ...
            reader.onload = function(e) {
                ...
                label.textContent = i === 0 ? 'Main Image' : `Image ${i + 1}`;
